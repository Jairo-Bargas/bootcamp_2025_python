...
from exercises.exercises_2 import mas_ejercicios


ordered_answers = mas_ejercicios()
...
def test_funcionanmiento_del_ejercicio_5():
    if function_ejercicio_5 is not None:
        assert (
            function_ejercicio_5(6, False) == 15
        ), "La sumatoria de números menores a 6 es 15"
        assert (
            function_ejercicio_5(6, True) == 9
        ), "La sumatoria de números menores a 6 es 9"
    else:
