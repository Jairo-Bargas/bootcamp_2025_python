...
from exercises.exercises_1 import primeros_ejercicios


ordered_answers = primeros_ejercicios()
collected_types = get_annotations_and_rvalues(primeros_ejercicios)
